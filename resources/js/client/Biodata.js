(function () {
        ...
        PrometricCertificate.forEach((prometric, index) => {
            if (index > 0) {
                if (isPrometricTrainee)
                    $("#add_prometric_trainee").trigger("click");
                else $("#add_prometric_not_trainee").trigger("click");
            }
            if (isPrometricTrainee) {
                if (options && index > 0)
                    $(`select[name='trainee_test_prometric_${index}']`).append(
                        options
                    );
                $(`select[name='trainee_test_prometric_${index}']`).val(
                    prometric.certificate
                );
                $(`input[name='trainee_taken_prometric_${index}']`).val(
                    prometric.taken
                );
                if (prometric.passed === 1)
                    $(`#trainee_passed_prometric_${index}`).prop(
                        "checked",
                        true
                    );
                else
                    $(`#trainee_failed_prometric_${index}`).prop(
                        "checked",
                        true
                    );
            } else {
                if (options && index > 0)
                    $(
                        `select[name='not_trainee_test_prometric_${index}']`
                    ).append(options);
                $(`select[name='not_trainee_test_prometric_${index}']`).val(
                    prometric.certificate
                );
                $(`input[name='not_trainee_taken_prometric_${index}']`).val(
                    prometric.taken
                );
                if (prometric.passed === 1)
                    $(`#not_trainee_passed_prometric_${index}`).prop(
                        "checked",
                        true
                    );
                else
                    $(`#not_trainee_failed_prometric_${index}`).prop(
                        "checked",
                        true
                    );
            }
    ...
    const handlePrometricLanguage = (options) => {
        ...
        PrometricLanguage.forEach((language, index) => {
            if (index > 0) {
                if (isPrometricTrainee)
                    $("#add_japlang_trainee").trigger("click");
                else $("#add_japlang_not_trainee").trigger("click");
            }
            if (isPrometricTrainee) {
                if (options && index > 0)
                    $(`select[name='trainee_test_jpl_${index}']`).append(
                        options
                    );
                $(`select[name='trainee_test_jpl_${index}']`).val(language.jpl);
                $(`input[name='trainee_taken_jpl_${index}']`).val(
                    language.taken
                );
                if (language.passed === 1)
                    $(`#trainee_passed_language_${index}`).prop(
                        "checked",
                        true
                    );
                else
                    $(`#trainee_failed_language_${index}`).prop(
                        "checked",
                        true
                    );
            } else {
                if (options && index > 0)
                    $(`select[name='not_trainee_test_jpl_${index}']`).append(
                        options
                    );
                $(`select[name='not_trainee_test_jpl_${index}']`).val(
                    language.jpl
                );
                $(`input[name='not_trainee_taken_jpl_${index}']`).val(
                    language.taken
                );
                if (language.passed === 1)
                    $(`#not_trainee_passed_language_${index}`).prop(
                        "checked",
                        true
                    );
                else
                    $(`#not_trainee_failed_language_${index}`).prop(
                        "checked",
                        true
                    );
            }
    ...
    Biodata.prototype = {
            ...
            if (type == "mod") {
                $.ajax({
                    ...
                    success: function (promise) {
                        ...
                        $("#middlename").val(
                            promise.personaldata[0].middle_name
                        );
                        $("#nickname").val(promise.personaldata[0].nickname);
                        $("#address").val(promise.personaldata[0].address);
                        $("#permanent_address").val(
                            promise.personaldata[0].permanentaddress
                        );
                        $("#birthday").val(promise.personaldata[0].date_birth);
                        $("#birth_place").val(
                            promise.personaldata[0].place_birth
                        );
                        $(
                            "input[name='gender'][value='" +
                                promise.personaldata[0].gender +
                                "']"
                        ).prop("checked", true);
                        $("select[name='citizenship']")
                            .val(promise.personaldata[0].citizenship)
                            .trigger("change");
                        $("#age").val(promise.personaldata[0].age);
                        $("select[name='blood_type']")
                            .val(promise.personaldata[0].bloodtype)
                            .trigger("change");
                        $("select[name='civil_status']")
                            .val(promise.personaldata[0].civil_status)
                            .trigger("change");
                        ...
                        $("input[name='weight']").val(
                            promise.personaldata[0].weight
                        );
                        $("input[name='jp_reading']").prop(
                            "checked",
                            promise.personaldata[0].jap_reading == 1
                                ? true
                                : false
                        );
                        $("input[name='jp_writing']").prop(
                            "checked",
                            promise.personaldata[0].jap_writing == 1
                                ? true
                                : false
                        );
                        $("input[name='jp_Speaking']").prop(
                            "checked",
                            promise.personaldata[0].jap_speaking == 1
                                ? true
                                : false
                        );
                        $("input[name='jp_Listening']").prop(
                            "checked",
                            promise.personaldata[0].jap_listening == 1
                                ? true
                                : false
                        );
                        $("input[name='weight']").val(
                        ...
                        $("input[name='other_lang']").val(
                            promise.personaldata[0].other_lang == null
                                ? ""
                                : promise.personaldata[0].other_lang
                        );
                        $("input[name='shoe_size']").val(
                            promise.personaldata[0].shoe_size
                        );
                        $("input[name='hobbies']").val(
                            promise.personaldata[0].hobbies
                        );
                        $("input[name='person_to_notify']").val(
                            promise.personaldata[0].person_to_notify
                        );
                        ...
                        $("input[name='person_contact']").val(
                            promise.personaldata[0].person_contact
                        );
                        $("input[name='passport']").val(
                            promise.personaldata[0].passport_no
                        );
                        $("input[name='issue_date']").val(
                            promise.personaldata[0].issue_date
                        );
                        $("input[name='expiry_date']").val(
                            promise.personaldata[0].expiry_date
                        );
                        $("input[name='issue_place']").val(
                            promise.personaldata[0].issue_place
                        );
                        $(
                            "input[name='allergy'][value='" +
                                promise.personaldata[0].allergy +
                                "']"
                        ).trigger("click");
                        $("input[name='food_allergy']").val(
                            promise.personaldata[0].food_alergy
                        );
                        $(
                            "input[name='tattoo'][value='" +
                                promise.personaldata[0].tattoo +
                                "']"
                        ).prop("checked", true);
                        $(
                            "input[name='licensed'][value='" +
                                promise.personaldata[0].drivers_licensed +
                                "']"
                        ).prop("checked", true);
                        ...
                        if (promise.personaldata[0].job_type == "SSW") {
                            if (promise.traineedata[0]["ex_trainee"] == 1) {
                                ...
                                CertificateId =
                                    promise.traineedata[0].jobcategory;
                                CertificateOperation =
                                    promise.traineedata[0].joboperation;
                            }
                            ...
                            if (promise.prometricsdata.length !== 0) {
                                ...
                                for (
                                    var i = 0;
                                    i < promise.prometricsdata.length;
                                    i++
                                ) {
                                    PrometricCertificate.push(
                                        promise.prometricsdata[i]
                                    );
                                }
                            } else {
                            ...
                            if (promise.languagedata.length !== 0) {
                                ...
                                for (
                                    var i = 0;
                                    i < promise.languagedata.length;
                                    i++
                                ) {
                                    PrometricLanguage.push(
                                        promise.languagedata[i]
                                    );
                                }
                            } else {
                        ...
                        //educational
                        $("input[name='name_elem']").val(
                            promise.educationaldata[0].name_elem
                        );
                        $("input[name='add_elem']").val(
                            promise.educationaldata[0].address_elem
                        );
                        $("input[name='date_from_elem']").val(
                            promise.educationaldata[0].from_elem
                        );
                        $("input[name='date_until_elem']").val(
                            promise.educationaldata[0].until_elem
                        );
                        $("input[name='name_highschool']").val(
                            promise.educationaldata[0].name_highschool
                        );
                        $("input[name='add_highschool']").val(
                            promise.educationaldata[0].address_highschool
                        );
                        $("input[name='date_from_highschool']").val(
                            promise.educationaldata[0].from_highschool
                        );
                        $("input[name='date_until_highschool']").val(
                            promise.educationaldata[0].until_highschool
                        );

                        if (promise.educationaldata[0].name_jp_lang != null) {
                            $("input[name='name_jpl']").val(
                                promise.educationaldata[0].name_jp_lang
                            );
                            $("input[name='add_jpl']").val(
                                promise.educationaldata[0].address_jp_lang
                            );
                            $("input[name='date_from_jpl']").val(
                                promise.educationaldata[0].from_jp_lang
                            );
                            $("input[name='date_until_jpl']").val(
                                promise.educationaldata[0].until_jp_lang
                            );
                            $("input[name='certificate_jpl']").val(
                        ...
                        if (promise.educationaldata[0].name_college) {
                            $("input[name='name_college']").val(
                                promise.educationaldata[0].name_college
                            );
                            $("input[name='add_college']").val(
                                promise.educationaldata[0].address_college
                            );
                            $("input[name='date_from_college']").val(
                                promise.educationaldata[0].from_college
                            );
                            $("input[name='date_until_college']").val(
                                promise.educationaldata[0].until_college
                            );
                            $("input[name='course_college']").val(
                                promise.educationaldata[0].course_college
                            );
                            $("select[name='certificate_college']")
                                .val(
                                    promise.educationaldata[0]
                                        .certificate_college
                                )
                                .trigger("change");
                            $("input[name='date_until_cert_college']").val(
                                promise.educationaldata[0]
                        ...
                        if (vocational.length > 0) {
                            promise.vocationaldata.forEach(
                                (vocational, index) => {
                                    if (index > 0)
                                        $("#add_vocational_btn").trigger(
                                            "click"
                                        );
                                    $(
                                        `input[name='name_vocational_${index}']`
                                    ).val(vocational.name);
                                    $(
                                        `input[name='add_vocational_${index}']`
                                    ).val(vocational.address);
                                    $(
                                        `input[name='date_from_vocational_${index}']`
                                    ).val(vocational.from);
                                    $(
                                        `input[name='date_until_vocational_${index}']`
                                    ).val(vocational.until);
                                    $(
                                        `input[name='course_vocational_${index}']`
                                    ).val(vocational.course);
                                    $(
                                        `input[name='certificate_vocational_${index}']`
                        ...
                        //localemployment
                        if (promise.employmentlocaldata.length == 0) $("#local_applicable").trigger("click");
                        else {
                            for ( let i = 0; i < promise.employmentlocaldata.length; i++ ) {
                                if (i != 0) $("#add_local_btn").trigger("click");
                                if(i === 0) {
                        ...
                        //abroademployment
                        if (promise.employmentabroaddata.length == 0) $("#abroad_applicable").trigger("click");
                        else {
                            for ( var i = 0; i < promise.employmentabroaddata.length; i++ ) {
                                if (i != 0) $("#add_abroad_btn").trigger("click");
                                if(i === 0) {
                        ...
                        //family
                        if (
                            promise.familydata[0].father_name == null &&
                            promise.familydata[0].father_cp == null
                        ) {
                            $(
                                "input[name='father_deceased'][value='3']"
                            ).trigger("click");
                        } else if (
                            promise.familydata[0].father_name != null &&
                            promise.familydata[0].father_cp == null
                            ...
                            $(
                                "input[name='father_deceased'][value='2']"
                            ).trigger("click");
                            $("input[name='father']").val(
                                promise.familydata[0].father_name
                            );
                            $("input[name='father_birthday']").val(
                                promise.familydata[0].father_birth
                            );
                        } else {
                            $("input[name='father']").val(
                                promise.familydata[0].father_name
                            ...
                            $("input[name='father_occupation']").val(
                                promise.familydata[0].father_occupation
                            );
                            $("input[name='father_cp']").val(
                                promise.familydata[0].father_cp
                            );
                            $("input[name='father_address']").val(
                                promise.familydata[0].father_address
                            );
                        }

                        if (
                            promise.familydata[0].mother_name == null &&
                            promise.familydata[0].mother_cp == null
                        ) {
                            $(
                                "input[name='mother_deceased'][value='3']"
                            ).trigger("click");
                        } else if (
                            promise.familydata[0].mother_name != null &&
                            promise.familydata[0].mother_cp == null
                            ...
                            $(
                                "input[name='mother_deceased'][value='2']"
                            ).trigger("click");
                            $("input[name='mother']").val(
                                promise.familydata[0].mother_name
                            );
                            $("input[name='mother_birthday']").val(
                                promise.familydata[0].mother_birth
                            );
                        } else {
                            $("input[name='mother']").val(
                                promise.familydata[0].mother_name
                            ...
                            $("input[name='mother_occupation']").val(
                                promise.familydata[0].mother_occupation
                            );
                            $("input[name='mother_cp']").val(
                                promise.familydata[0].mother_cp
                            );
                            $("input[name='mother_address']").val(
                                promise.familydata[0].mother_address
                            );
                        }
                        if (
                            $("select[name='civil_status']").val() == "Married"
                        ) {
                            $("input[name='spouse']").val(
                                promise.familydata[0].spouse_name
                            );
                            $("input[name='spouse_birthday']").val(
                                promise.familydata[0].spouse_birth
                            );
                            $("input[name='spouse_occupation']").val(
                                promise.familydata[0].spouse_occupation
                            );
                            $("input[name='spouse_cp']").val(
                                promise.familydata[0].spouse_cp
                            );
                            $("input[name='spouse_address']").val(
                                promise.familydata[0].spouse_address
                            );
                            ...
                            spouse.occupation =
                                promise.familydata[0].spouse_occupation;
                            spouse.birthday =
                                promise.familydata[0].spouse_nbirth;
                            spouse.address =
                                promise.familydata[0].spouse_address;
                        }
                        if (promise.familydata[0].partner_name != null) {
                            ...
                            $("input[name='partner']").val(
                                promise.familydata[0].partner_name
                            );
                            $("input[name='partner_birthday']").val(
                                promise.familydata[0].partner_birthday
                            );
                            $("input[name='partner_Occupation']").val(
                                promise.familydata[0].partner_Occupation
                            );
                            $("input[name='partner_cp']").val(
                                promise.familydata[0].partner_cp
                            );
                            $("input[name='partner_address']").val(
                                promise.familydata[0].partner_address
                            );
                        }
                        if (promise.familydata[0].went_japan == 0) {
                            ...
                            $("input[name='japan_times']").val(
                                promise.familydata[0].how_many_japan
                            );
                            for (
                                var i = 0;
                                i < promise.japanvisitdata.length;
                                i++
                            ) {
                                if (i != 0)
                                    $("#add_japanvisit").trigger("click");
                                $(`input[name='japan_where_${i}']`).val(
                                    promise.japanvisitdata[i].where
                                );
                                $(`input[name='japan_from_when_${i}']`).val(
                                    promise.japanvisitdata[i].fromwhen
                                );
                                $(`input[name='japan_until_when_${i}']`).val(
                                    promise.japanvisitdata[i].untilwhen
                                );
                            }

                            if (promise.familydata[0].overstay_japan === 1) {
                                $("#jp_overstay_yes").trigger("click");
                                $("#jp_overstay_count").val(
                                    promise.familydata[0].how_long_overstay
                                );
                            } else {
                            ...
                            if (
                                promise.familydata[0].fake_identity_japan == 0
                            ) {
                                $(
                                    "input[name='fakeidentity'][value='" +
                                        promise.familydata[0]
                                            .fake_identity_japan +
                                        "']"
                                ).trigger("click");
                            } else {
                                ...
                                $("input[name='fakeidentity_purpose']").val(
                                    promise.familydata[0].fake_identity_purpose
                                );
                                $(
                                    "input[name='fakeidentity_surrendered'][value='" +
                                        promise.familydata[0]
                        ...
                        if (promise.familydata[0].applied_visa == 0) {
                            $(
                                "input[name='visa'][value='" +
                                    promise.familydata[0].applied_visa +
                                    "']"
                            ).trigger("click");
                        } else {
                            $(
                            ...
                            $("select[name='visa_type']")
                                .val(promise.familydata[0].type_visa)
                                .trigger("change");
                            $("input[name='visa_when']").val(
                                promise.familydata[0].when_applied_visa
                            );
                            $("select[name='visa_approved']")
                                .val(promise.familydata[0].approved)
                                .trigger("change");
                            const visa = promise.visa;
                            visa.forEach((item, index) => {
                                if (index > 0) $("#add-visa").trigger("click");
                                $(".visa-type:last")
                                    .val(item.type)
                                    .trigger("change");
                                $(".visa-date:last").val(item.applied_at);
                                $(".visa-is-approved:last")
                                    .val(item.is_approved)
                                    .trigger("change");
                            });
                        }
                        ...
                        if (promise.siblingdata.length == 0) {
                            ...
                            for (
                                var i = 0;
                                i < promise.siblingdata.length;
                                i++
                            ) {
                                if (i != 0) $("#add_sibling").trigger("click");
                                $("input[name='sibling_" + i + "']").val(
                                    promise.siblingdata[i].sibling_name
                                );
                                $(
                                    "input[name='sibling_birthday_" + i + "']"
                                ).val(promise.siblingdata[i].sibling_birth);
                                $(
                                    "input[name='sibling_occupation_" + i + "']"
                                ).val(
                                    promise.siblingdata[i].sibling_occupation
                                );
                                $("input[name='sibling_cp_" + i + "']").val(
                                    promise.siblingdata[i].sibling_cp
                                );
                                $(
                                    "input[name='sibling_address_" + i + "']"
                                ).val(promise.siblingdata[i].sibling_address);
                            }
                        }
                        ...
                        if (promise.childrendata.length == 0) {
                            ...
                            for (
                                var i = 0;
                                i < promise.childrendata.length;
                                i++
                            ) {
                                if (i != 0) $("#add_children").trigger("click");
                                $("input[name='child_" + i + "']").val(
                                    promise.childrendata[i].name
                                );
                                $("input[name='child_birthday_" + i + "']").val(
                                    promise.childrendata[i].birthday
                                );
                                $("input[name='child_address_" + i + "']").val(
                                    promise.childrendata[i].address
                                );
                            }
                        }
                        ...
                        if (promise.relativedata.length == 0) {
                            ...
                            for (
                                var i = 0;
                                i < promise.relativedata.length;
                                i++
                            ) {
                                if (i != 0)
                                    $("#add_relatives").trigger("click");
                                $("input[name='name_relative_" + i + "']").val(
                                    promise.relativedata[i].name
                                );
                                $(
                                    "input[name='relation_relative_" + i + "']"
                                ).val(promise.relativedata[i].relation);
                                $(
                                    "input[name='contact_relative_" + i + "']"
                                ).val(promise.relativedata[i].cp);
                                $(
                                    "input[name='address_relative_" + i + "']"
                                ).val(promise.relativedata[i].address);
                            }
                        }
                        ...
                        var passportIDName =
                            promise.personaldata[0].passport_id_filename;
                        biodata.loadURLToInputField(
                            "/storage/1x1_pictures/" + pictureName,
                            pictureName,
                            "picture"
                        );
                        biodata.loadURLToInputField(
                            "/storage/gov_id_pictures/" + govIDName,
                            govIDName,
                            "gov_id"
                        );
                        biodata.loadURLToInputField(
                            "/storage/passport_id_pictures/" + passportIDName,
                            passportIDName,
                            "passport_id"
                        );
                    },
                    ...
                    if (promise.success) {
                        ...
                        setTimeout(() => {
                            if (self.searchParams.get("type") != "mod")
                                location.replace(
                                    location.pathname.includes("/jp")
                                        ? "/jp/"
                                        : "/"
                                );
                            else
                                location.replace(
                                    "/admin/ManagementRegistration"
                                );
                        }, 2000);
                    }
                },
        ...
        countRow: function (lblClass, lblText) {
            ...
            $(".lbl" + lblClass).each(function () {
                $(this).html(
                    lblText + " " + count + "<span style='color:red'>*</span>:"
                );
                count++;
            });
        },
        ...
        loadFunctions: function () {
            let self = this;
            if (
                self.searchParams.get("type") != "mod" &&
                !self.searchParams.has("cat")
            ) {
                $("#opening").hide();
            }
            self.getData();
    ...
    $(document).ready(function () {
                    ...
                    $("[data-tab-content]")
                        ...
                        .forEach((content) => {
                            if (!$(content).hasClass("hidden")) {
                                let validRun = $(content)
                                    .find("form")
                                    .attr("id");
                                switch (validRun) {
                                    case "personal_form":
                                        valid = biodata.personal_validator
                                            ? $(content).find("form").valid()
                                            : true;
                                        break;
                                    case "certificate_form":
                                        valid = biodata.certificate_validator
                                            ? $(content).find("form").valid()
                                            : true;
                                        break;
                                    case "educational_form":
                                        valid = biodata.educational_validator
                                            ? $(content).find("form").valid()
                                            : true;
                                        break;
                                    case "empLocal_form":
                                        valid = biodata.local_emp_validator
                                            ? $(content).find("form").valid()
                                            : true;
                                        break;
                                    case "empAbroad_form":
                                        valid = biodata.abroad_emp_validator
                                            ? $(content).find("form").valid()
                                            : true;
                                        break;
                                    case "family_form":
                                        valid = biodata.family_validator
                                            ? $(content).find("form").valid()
                                            : true;
                                        break;
                                    case "upload_form":
                                        valid = biodata.upload_validator
                                            ? $(content).find("form").valid()
                                            : true;
                                        break;
                                }
        ...
        let personalvalid = $("#personal_form").validate({
            ...
            submitHandler: function (form) {
                ...
                biodata.personalData.contact = parseInt(
                    biodata.personalData.contact
                );
                biodata.personalData.height = parseInt(
                    biodata.personalData.height
                );
                biodata.personalData.weight = parseInt(
                    biodata.personalData.weight
                );
                biodata.personalData.shoe_size = parseFloat(
                    biodata.personalData.shoe_size
                );
                biodata.personalData.religion =
                    biodata.personalData.religion == "Others"
                        ? $("#religion").val()
                        : biodata.personalData.religion;
                $(window).scrollTop(0);
        ...
        $("select[name='religion']").on("change", function () {
            if ($(this).val() == "Others") {
                let input =
                    "<div class='religion mt-2 md:mt-2 form-group col-span-3'><input id='religion' autocomplete='off' type='text' maxlength='100' class=' form-control disabled:bg-slate-200' placeholder='Other religion' required></div>";
            ...
            submitHandler: function (form) {
                ...
                if (biodata.ex_trainee) {
                    $(".trainee_prometric").each(function () {
                        ...
                        if (
                            $(
                                'select[name="trainee_test_prometric_' +
                                    ind +
                                    '"]'
                            ).val()
                        ) {
                            biodata.prometricData.push({
                                ...
                                taken: $(
                                    'input[name="trainee_taken_prometric_' +
                                        ind +
                                        '"]'
                                ).val(),
                                passed: $(
                                    `#trainee_passed_prometric_${ind}`
                                ).prop("checked"),
                            });
                        }
                    });
                    ...
                    $(".trainee_jpl").each(function () {
                        ...
                        if (
                            $(
                                'select[name="trainee_test_jpl_' + ind + '"]'
                            ).val()
                        ) {
                            biodata.jplData.push({
                                test: $(
                                    'select[name="trainee_test_jpl_' +
                                        ind +
                                        '"]'
                                ).val(),
                                taken: $(
                                    'input[name="trainee_taken_jpl_' +
                                        ind +
                                        '"]'
                                ).val(),
                                passed: $(
                                    `#trainee_passed_language_${ind}`
                                ).prop("checked"),
                            });
                        }
                    });
                    ...
                    $(".nottrainee_prometric").each(function () {
                        ...
                        if (
                            $(
                                'select[name="not_trainee_test_prometric_' +
                                    ind +
                                    '"]'
                            ).val()
                        ) {
                            biodata.prometricData.push({
                                ...
                                taken: $(
                                    'input[name="not_trainee_taken_prometric_' +
                                        ind +
                                        '"]'
                                ).val(),
                                passed: $(
                                    `#not_trainee_passed_prometric_${ind}`
                                ).prop("checked"),
                            });
                        }
                    });
                    ...
                    $(".nottrainee_jpl").each(function () {
                        ...
                        if (
                            $(
                                'select[name="not_trainee_test_jpl_' +
                                    ind +
                                    '"]'
                            ).val()
                        ) {
                            biodata.jplData.push({
                                ...
                                taken: $(
                                    'input[name="not_trainee_taken_jpl_' +
                                        ind +
                                        '"]'
                                ).val(),
                                passed: $(
                                    `#not_trainee_passed_language_${ind}`
                                ).prop("checked"),
                            });
                        }
                    });
        ...
        $("#add_prometric_trainee").on("click", function (e) {
            ...
            let form = `<div class="md:grid my-3 grid-cols-7 gap-4 biodata-id-priometric}">
                        <div class="mt-2 md:mt-0 form-group col-span-3">
                            <select id="trainee_test_prometric_${
                                id + 1
                            }" required name="trainee_test_prometric_${
                id + 1
            }" class="trainee_prometric form-select disabled:bg-slate-200">
                        ...
                        <div class="relative" data-te-datepicker-init data-te-inline="true" data-te-disable-future="true" data-te-format="mm/dd/yyyy" data-te-input-wrapper-init>
                            <input data-rule-validDate="true" name="trainee_taken_prometric_${
                                id + 1
                            }" maxlength="10" autocomplete="off" type="text" required class=" form-control date_picker disabled:bg-slate-200" placeholder="Date Taken" />
                        </div>
                        </div>
                        <div class="form-group col-span-2">
                            <div class="flex">
                                <div class="flex items-center mr-5">
                                    <input required type="radio" value="1" id="trainee_passed_prometric_${
                                        id + 1
                                    }" name="trainee_result_prometric_${
                id + 1
            }" class="w-4 h-4 disabled:bg-slate-200 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 ">
                                    <label for="inline-radio" class="ml-2 text-sm md:text-xl text-gray-900">Passed</label>
                                </div>
                                <div class="flex items-center mr-4">
                                    <input required type="radio" value="0" id="trainee_failed_prometric_${
                                        id + 1
                                    }" name="trainee_result_prometric_${
                id + 1
            }" class="w-4 h-4 disabled:bg-slate-200 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 ">
                        ...
                        <div class="mt-2 md:mt-0 form-group col-span-1">
                            <button id="remove_prometric_trainee_${
                                id + 1
                            }" class="py-2 px-4 bg-red-700 rounded w-full self-end text-sm text-white">Remove Record</button>
                        </div>
                    </div>`;
            ...
            $(`#remove_prometric_trainee_${id + 1}`).on("click", function (e) {
                ...
                PrometricCertificate = PrometricCertificate.filter(
                    (cert) => cert.certificate !== select.val()
                );
            ...
            $(`select[name='trainee_test_prometric_${id + 1}']`).on(
                "change",
                function () {
                    if ($(this).val() == "Others") {
                        let input =
                            "<div class='prometric_test mt-2 md:mt-0 form-group col-span-3'><input autocomplete='off' type='text' maxlength='100' class=' form-control disabled:bg-slate-200' placeholder='Prometric Test' required></div>";
        ...
        <div class="mt-2 md:mt-0 form-group col-span-3">
            <select required name="not_trainee_test_prometric_${
                id + 1
            }" class="nottrainee_prometric disabled:bg-slate-200 form-select">
                ${biodata.prometric_options}
            </select>
        </div>
        <div class="mt-2 md:mt-0 form-group col-span-1">
            <div class="relative" data-te-datepicker-init data-te-inline="true" data-te-disable-future="true" data-te-format="mm/dd/yyyy" data-te-input-wrapper-init>
                <input data-rule-validDate="true" name="not_trainee_taken_prometric_${
                    id + 1
                }" maxlength="10" autocomplete="off" type="text" required class=" form-control date_picker disabled:bg-slate-200" placeholder="Date Taken" />
           </div>
        </div>
        <div class="form-group col-span-2">
            <div class="flex">
                <div class="flex items-center mr-5">
                    <input required type="radio" value="1" id="not_trainee_passed_prometric_${
                        id + 1
                    }" name="not_trainee_result_prometric_${
                id + 1
            }" class="w-4 h-4 disabled:bg-slate-200 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 ">
                    <label for="inline-radio" class="ml-2 text-xl text-gray-900">Passed</label>
                </div>
                <div class="flex items-center mr-4">
                    <input required type="radio" value="0" id="not_trainee_failed_prometric_${
                        id + 1
                    }" name="not_trainee_result_prometric_${
                id + 1
            }" class="w-4 h-4 disabled:bg-slate-200 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 ">
        ...
        <div class="mt-2 md:mt-0 form-group col-span-1">
            ...
            $(`select[name='not_trainee_test_prometric_${id + 1}']`).on(
                "change",
                function () {
                    if ($(this).val() == "Others") {
                        let input =
        ...
        <div class="mt-2 md:mt-0 form-group col-span-3">
            <select id="trainee_test_jpl_${
                id + 1
            }" required name="trainee_test_jpl_${
                id + 1
            }" class="trainee_jpl disabled:bg-slate-200 form-select">
                ${biodata.japlang_options}
            </select>
        </div>
        <div class="mt-2 md:mt-0 form-group col-span-1">
            <div class="relative" data-te-datepicker-init data-te-inline="true" data-te-disable-future="true" data-te-format="mm/dd/yyyy" data-te-input-wrapper-init>
                <input data-rule-validDate="true" name="trainee_taken_jpl_${
                    id + 1
                }" maxlength="10" autocomplete="off" type="text" required class=" form-control date_picker disabled:bg-slate-200" placeholder="Date Taken" />
           </div>
        </div>
        <div class="form-group col-span-2">
            <div class="flex">
                <div class="flex items-center mr-5">
                    <input required type="radio" value="1" id="trainee_passed_language_${
                        id + 1
                    }" name="trainee_result_jpl_${
                id + 1
            }" class="w-4 h-4 disabled:bg-slate-200 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 ">
                    <label for="inline-radio" class="ml-2 text-sm md:text-xl text-gray-900">Passed</label>
                </div>
                <div class="flex items-center mr-4">
                    <input required type="radio" value="0" id="trainee_failed_language_${
                        id + 1
                    }" name="trainee_result_jpl_${
                id + 1
            }" class="w-4 h-4 disabled:bg-slate-200 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 ">
        ...
        <div class="mt-2 md:mt-0 form-group col-span-1">
            ...
            $(`#remove_jpl_trainee_${id + 1}`).on("click", function (e) {
                ...
                PrometricLanguage = PrometricLanguage.filter(
                    (language) => language.jpl !== select.val()
                );
                $(this).closest(".grid-cols-7").remove();
            });
        ...
        <div class="mt-2 md:mt-0 form-group col-span-3">
            <select required name="not_trainee_test_jpl_${
                id + 1
            }" class="nottrainee_jpl disabled:bg-slate-200 form-select">
            ${biodata.japlang_options}
            </select>
        </div>
        <div class="mt-2 md:mt-0 form-group col-span-1">
            <div class="relative" data-te-datepicker-init data-te-inline="true" data-te-disable-future="true" data-te-format="mm/dd/yyyy" data-te-input-wrapper-init>
                <input data-rule-validDate="true" name="not_trainee_taken_jpl_${
                    id + 1
                }" maxlength="10" autocomplete="off" type="text" required class=" form-control date_picker disabled:bg-slate-200" placeholder="Date Taken" />
           </div>
        </div>
        <div class="form-group col-span-2">
            <div class="flex">
                <div class="flex items-center mr-5">
                    <input required type="radio" value="1" id="not_trainee_passed_language_${
                        id + 1
                    }" name="not_trainee_result_jpl_${
                id + 1
            }" class="w-4 h-4 disabled:bg-slate-200 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 ">
                    <label for="inline-radio" class="ml-2 text-xl text-gray-900">Passed</label>
                </div>
                <div class="flex items-center mr-4">
                    <input required type="radio" value="0" id="not_trainee_failed_language_${
                        id + 1
                    }" name="not_trainee_result_jpl_${
                id + 1
            }" class="w-4 h-4 disabled:bg-slate-200 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 ">
        ...
        $("select[name='not_trainee_test_prometric_0']").on(
            "change",
            function () {
                if ($(this).val() == "Others") {
                    let input =
                ...
                $(".voc").each(function () {
                    ...
                    if ($('input[name="name_vocational_' + ind + '"]').val()) {
                        biodata.vocationalData.push({
                            name: $(
                                'input[name="name_vocational_' + ind + '"]'
                            ).val(),
                            address: $(
                                'input[name="add_vocational_' + ind + '"]'
                            ).val(),
                            from: $(
                                'input[name="date_from_vocational_' + ind + '"]'
                            ).val(),
                            until: $(
                                'input[name="date_until_vocational_' +
                                    ind +
                                    '"]'
                            ).val(),
                            course: $(
                                'input[name="course_vocational_' + ind + '"]'
                            ).val(),
                            certificate: $(
                                'input[name="certificate_vocational_' +
                                    ind +
                                    '"]'
                            ).val(),
                            certificate_until: $(
                                'input[name="date_until_cert_vocational_' +
                                    ind +
                                    '"]'
                            ).val(),
                        });
        ...
        <div class="mt-2 md:mt-0 form-group col-span-3">
            <input name="name_vocational_${
                id + 1
            }" autocomplete="off" type="text" maxlength="100" class="voc form-control" placeholder="Name of School" required>
        </div>
        <div class="mt-2 md:mt-0 form-group col-span-2">
            <input name="add_vocational_${
                id + 1
            }" autocomplete="off" type="text" maxlength="100" class="form-control" placeholder="School Address" required>
        </div>
        <div class="mt-2 md:mt-0 form-group col-span-1">
        <div class="relative" data-te-datepicker-init data-te-inline="true" data-te-disable-future="true" data-te-format="mm/dd/yyyy" data-te-input-wrapper-init>
        <input data-rule-validDate="true" name="date_from_vocational_${
            id + 1
        }"  maxlength="10" autocomplete="off" type="text" required class="form-control date_picker disabled:bg-slate-200" placeholder="Date From" />
   </div>
        </div>
        <div class="mt-2 md:mt-0 form-group col-span-1">
        <div class="relative" data-te-datepicker-init data-te-inline="true" data-te-disable-future="true" data-te-format="mm/dd/yyyy" data-te-input-wrapper-init>
        <input data-rule-validDate="true" data-rule-pastDate="true" name="date_until_vocational_${
            id + 1
        }" maxlength="10" autocomplete="off" type="text" required class="form-control date_picker disabled:bg-slate-200" placeholder="Date Until" />
   </div>
        </div>
        <div class="mt-2 md:mt-0 form-group col-span-4">
            <input name="course_vocational_${
                id + 1
            }" autocomplete="off" type="text" maxlength="100" class="form-control" placeholder="Course/Major" required>
        </div>
        <div class="mt-2 md:mt-0 form-group col-span-2">
            <input name="certificate_vocational_${
                id + 1
            }" autocomplete="off" type="text" maxlength="100" class="form-control" placeholder="Certificate Holder" required>
        </div>
        <div class="mt-2 md:mt-0 form-group col-span-1">
        <div class="relative" data-te-datepicker-init data-te-inline="true" data-te-disable-future="true" data-te-format="mm/dd/yyyy" data-te-input-wrapper-init>
        <input data-rule-validDate="true" data-rule-pastDate="true" name="date_until_cert_vocational_${
            id + 1
        }" maxlength="10" autocomplete="off" type="text" required class="form-control date_picker disabled:bg-slate-200" placeholder="Date Until" />
   </div>
        </div>
                ...
                $(".local").each(function (index) {
                    ...
                    if ($("#name_local_" + ind).val()) {
                        biodata.local_empData.push({
                            ...
                            until:
                                index === 0 &&
                                $("#local-is-present-date").prop("checked")
                                    ? "2200-01-01"
                                    : $("#date_until_local_" + ind).val(),
                        });
                    }
                });
        ...
        $("#add_local_btn").on("click", function (e) {
            ...
            let forms = `<div class='companylocal md:grid grid-cols-9 gap-4' id='company_${
                id + 1
            }'>
        <div class='mt-2 md:mt-0 form-group col-span-9'>
            <label class='text-xl font-bold lblLocalCompany'>Company ${
                count + 1
        ...
        <div class='col-span-8 md:grid grid-cols-4 gap-4'>
            <div class='mt-2 md:mt-0 form-group col-span-2'>
                <input name='name_local_${id + 1}' id='name_local_${
                id + 1
            }' autocomplete='off' type='text' class='local name_local form-control disabled:bg-slate-200' placeholder='Name of Company' required>
            </div>
        <div class='mt-2 md:mt-0 form-group col-span-2'>
            <input name='position_local_${id + 1}' id='position_local_${
                id + 1
            }' autocomplete='off' type='text' class='position_local form-control disabled:bg-slate-200' placeholder='Position' required>
        </div>
        <div class='mt-2 md:mt-0 form-group col-span-2'>
            <input name='address_local_${id + 1}' id='address_local_${
                id + 1
            }' autocomplete='off' type='text' class='address_local form-control disabled:bg-slate-200' placeholder='Company Address' required>
        </div>
        <div class='mt-2 md:mt-0 form-group col-span-1'>
        <div class="relative" data-te-datepicker-init data-te-inline="true" data-te-disable-future="true" data-te-format="mm/dd/yyyy" data-te-input-wrapper-init>
        <input data-rule-validDate="true" name="date_from_local_${
            id + 1
        }" id='date_from_local_${
                id + 1
            }' maxlength="10" autocomplete="off" type="text" required class="date_until_local_0 form-control date_picker disabled:bg-slate-200" placeholder="Date From" />
   </div>
        </div>
        <div class='mt-2 md:mt-0 form-group col-span-1'>
        <div class="relative" data-te-datepicker-init data-te-inline="true" data-te-disable-future="true" data-te-format="mm/dd/yyyy" data-te-input-wrapper-init>
        <input data-rule-validDate="true" name="date_until_local_${
            id + 1
        }" id='date_until_local_${
                id + 1
            }' maxlength="10" autocomplete="off" type="text" required class="date_until_local_0 form-control date_picker disabled:bg-slate-200" placeholder="Date Until" />
   </div>
        </div>
        </div>
        </div>`;
        ...
        $("#local_applicable").on("click", function (e) {
            if (this.checked) {
                ...
                $("#local_required").html("*");
                if($('#local-is-present-date').prop('checked')) $('#date_until_local_0').prop('disabled', true)
            }
        });
        ...
        $("#local-is-present-date").on("click", (e) => {
            $("#date_until_local_0").val("");
            if (e.currentTarget.checked)
                $("#date_until_local_0").prop("disabled", true);
            else $("#date_until_local_0").prop("disabled", false);
        });
                ...
                $(".abroad").each(function (index) {
                    ...
                    if ($("#name_abroad_" + ind).val()) {
                        biodata.abroad_empData.push({
                            ...
                            until:
                                index === 0 &&
                                $("#abroad-is-present-date").prop("checked")
                                    ? "2200-01-01"
                                    : $("#date_until_abroad_" + ind).val(),
                        });
                    }
                });
        ...
        $("#add_abroad_btn").on("click", function (e) {
            ...
            let forms = `<div class='companyabroad md:grid grid-cols-9 gap-4' id='company_${
                id + 1
            }'>
        <div class='mt-2 md:mt-0 form-group col-span-9'>
            <label class='text-xl font-bold lblAbroadCompany'>Company ${
                count + 1
            }<span style='color:red'>*</span>:</label>
        </div>
        <div class='mt-2 md:mt-0 form-group col-span-1'>
        ...
        <div class='col-span-8 md:grid grid-cols-4 gap-4'>
            <div class='mt-2 md:mt-0 form-group col-span-2'>
                <input name='name_abroad_${id + 1}' id='name_abroad_${
                id + 1
            }' autocomplete='off' type='text' class='abroad_${
                id + 1
            } form-control disabled:bg-slate-200' placeholder='Name of Company' required>
            </div>
        <div class='mt-2 md:mt-0 form-group col-span-2'>
            <input name='position_abroad_${id + 1}' id='position_abroad_${
                id + 1
            }' autocomplete='off' type='text' class='form-control disabled:bg-slate-200' placeholder='Position' required>
        </div>
        <div class='mt-2 md:mt-0 form-group col-span-2'>
            <input name='address_abroad_${id + 1}' id='address_abroad_${
                id + 1
            }' autocomplete='off' type='text' class='form-control disabled:bg-slate-200' placeholder='Company Address' required>
        </div>
        <div class='mt-2 md:mt-0 form-group col-span-1'>
        <div class="relative" data-te-datepicker-init data-te-inline="true" data-te-disable-future="true" data-te-format="mm/dd/yyyy" data-te-input-wrapper-init>
        <input data-rule-validDate="true" name="date_from_abroad_${
            id + 1
        }" id='date_from_abroad_${
                id + 1
            }' maxlength="10" autocomplete="off" type="text" required class=" form-control date_picker disabled:bg-slate-200" placeholder="Date From" />
   </div>
        </div>
        <div class='mt-2 md:mt-0 form-group col-span-1'>
        <div class="relative" data-te-datepicker-init data-te-inline="true" data-te-disable-future="true" data-te-format="mm/dd/yyyy" data-te-input-wrapper-init>
        <input data-rule-validDate="true" name="date_until_abroad_${
            id + 1
        }" id='date_until_abroad_${
                id + 1
            }' maxlength="10" autocomplete="off" type="text" required class=" form-control date_picker disabled:bg-slate-200" placeholder="Date Until" />
   </div>
        </div>
        ...
        $("#abroad_applicable").on("click", function (e) {
            if (this.checked) {
                ...
                $("#abroad_required").html("*");
                if($('#abroad-is-present-date').prop('checked')) $('#date_until_abroad_0').prop('disabled', true)
            }
        });
        ...
        $("#abroad-is-present-date").on("click", (e) => {
            $("#date_until_abroad_0").val("");
            if (e.currentTarget.checked)
                $("#date_until_abroad_0").prop("disabled", true);
            else $("#date_until_abroad_0").prop("disabled", false);
        });
                ...
                $(".siblings").each(function () {
                    ...
                    if ($('input[name="sibling_' + ind + '"]').val()) {
                        biodata.siblingData.push({
                            ...
                            birhtday: $(
                                'input[name="sibling_birthday_' + ind + '"]'
                            ).val(),
                            occupation: $(
                                'input[name="sibling_occupation_' + ind + '"]'
                            ).val(),
                            cp: $('input[name="sibling_cp_' + ind + '"]').val(),
                            address: $(
                                'input[name="sibling_address_' + ind + '"]'
                            ).val(),
                        });
                    }
                });
                ...
                $(".childrens").each(function () {
                    ...
                    if ($('input[name="child_' + ind + '"]').val()) {
                        biodata.childrenData.push({
                            ...
                            birthday: $(
                                'input[name="child_birthday_' + ind + '"]'
                            ).val(),
                            address: $(
                                'input[name="child_address_' + ind + '"]'
                            ).val(),
                        });
                    }
                });
                ...
                $(".japantimes").each(function () {
                    ...
                    if ($('input[name="name_relative_' + ind + '"]').val()) {
                        biodata.relativeData.push({
                            name: $(
                                'input[name="name_relative_' + ind + '"]'
                            ).val(),
                            relation: $(
                                'input[name="relation_relative_' + ind + '"]'
                            ).val(),
                            contact: $(
                                'input[name="contact_relative_' + ind + '"]'
                            ).val(),
                            address: $(
                                'input[name="address_relative_' + ind + '"]'
                            ).val(),
                        });
                    }
                });
                ...
                $(".japantimes").each(function () {
                    ...
                    if ($('input[name="japan_where_' + ind + '"]').val()) {
                        biodata.japanvisitData.push({
                            where: $(
                                'input[name="japan_where_' + ind + '"]'
                            ).val(),
                            fromwhen: $(
                                'input[name="japan_from_when_' + ind + '"]'
                            ).val(),
                            untilwhen: $(
                                'input[name="japan_until_when_' + ind + '"]'
                            ).val(),
                        });
                    }
                });

                const type = $(".visa-type");
                const date = $(".visa-date");
                const isApproved = $(".visa-is-approved");
                for (let i = 0; i < type.length; i++) {
                    biodata.visa.push({
                        type: type[i].value,
                        appliedAt: date[i].value,
                        isApproved: isApproved[i].value,
                    });
                }
        ...
        <div class="form-group col-span-13">
                    <div class="flex justify-end">
                        <div class="flex items-center mr-4">
                            <input type="radio" value="1" name="sibling_${
                                id + 1
                            }_deceased" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 " checked>
                            <label for="inline-radio" class="ml-2 text-lg text-gray-900">Available</label>
                        </div>
                        <div class="flex items-center mr-4">
                            <input type="radio" value="2" name="sibling_${
                                id + 1
                            }_deceased" class=" w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 ">
        ...
        <div class="form-group col-span-3">
            ...
            <input name="sibling_${
                id + 1
            }" autocomplete="off" type="text" maxlength="100" class="siblings sibling_${
                id + 1
            } form-control disabled:bg-slate-200" required>
        </div>
        <div class="form-group col-span-3">
            ...
            <div class="relative" data-te-datepicker-init data-te-disable-future="true" data-te-inline="true" data-te-format="mm/dd/yyyy" data-te-input-wrapper-init>
                        <input data-rule-validDate="true" data-rule-pastDate="true" name="sibling_birthday_${
                            id + 1
                        }" maxlength="10" autocomplete="off" type="text" required class="sibling_${
                id + 1
            } form-control date_picker disabled:bg-slate-200" placeholder="MM/DD/YYYY" />
                   </div>
        </div>
        <div class="form-group col-span-3">
            <label for="lastname" class="form-label">Occupation<span class="req_sibling_${
                id + 1
            }_deceased" style="color:red">*</span>:</label>
            <input name="sibling_occupation_${
                id + 1
            }" autocomplete="off" type="text" maxlength="100" class="sibling_${
                id + 1
            }_deceased form-control disabled:bg-slate-200" required>
        </div>
        <div class="form-group col-span-3">
            <label for="lastname" class="form-label">CP No.<span class="req_sibling_${
                id + 1
            }_deceased" style="color:red"></span>:</label>
            <input name="sibling_cp_${
                id + 1
            }" autocomplete="off" type="text" maxlength="100" class="sibling_${
                id + 1
            }_deceased form-control disabled:bg-slate-200" minlength="8">
        </div>
        <div class="form-group col-start-2 col-span-12">
            <label for="lastname" class="form-label">Address<span class="req_sibling_${
                id + 1
            }_deceased" style="color:red">*</span>:</label>
            <input name="sibling_address_${
                id + 1
            }" autocomplete="off" type="text" maxlength="100" class="sibling_${
                id + 1
            }_deceased form-control disabled:bg-slate-200" required>
            ...
            $(`input[name='sibling_${id + 1}_deceased']`).on(
                "click",
                function () {
                    if ($(this).val() == 1) {
                        family_form.resetForm();
                        $(`.sibling_${id + 1}_deceased`).attr(
                            "disabled",
                            false
                        );
        ...
        <div class="form-group col-span-3">
            ...
            <input name="child_${
                id + 1
            }" autocomplete="off" type="text" maxlength="100" class="childrens children form-control disabled:bg-slate-200" required>
        </div>
        <div class="form-group col-span-1">
            <label for="lastname" class="form-label">Birth Date<span style="color:red">*</span>:</label>
            <div class="relative" data-te-datepicker-init data-te-inline="true" data-te-disable-future="true" data-te-format="mm/dd/yyyy" data-te-input-wrapper-init>
                     <input data-rule-validDate="true" data-rule-pastDate="true" name="child_birthday_${
                         id + 1
                     }" maxlength="10" autocomplete="off" type="text" required class="children form-control date_picker disabled:bg-slate-200" placeholder="MM/DD/YYYY" />
                </div>
        </div>
        <div class="form-group col-span-6">
                <label for="lastname" class="form-label">Address<span style="color:red" class="required_children">*</span>:</label>
                <input name="child_address_${
                    id + 1
                }" autocomplete="off" type="text" maxlength="100" class="children form-control disabled:bg-slate-200" required>
            </div>
    </div>`;
        ...
        <div class="form-group col-span-4 japan_group">
            ...
            <input name="japan_where_${
                id + 1
            }" autocomplete="off" type="text" maxlength="100" class="japantimes japan form-control disabled:bg-slate-200" required>
        </div>
        <div class="form-group col-span-2 japan_group">
            <label for="lastname" class="form-label">From When</label>
            <div class="relative" data-te-datepicker-init data-te-inline="true" data-te-disable-future="true" data-te-format="mm/dd/yyyy" data-te-input-wrapper-init>
                <input data-rule-validDate="true" data-rule-pastDate="true" name="japan_from_when_${
                    id + 1
                }" maxlength="10" autocomplete="off" type="text" required class="spouse form-control date_picker disabled:bg-slate-200" placeholder="MM/DD/YYYY" />
           </div>
        </div>
        <div class="form-group col-span-2 japan_group">
            <label for="lastname" class="form-label">Until When</label>
            <div class="relative" data-te-datepicker-init data-te-inline="true" data-te-disable-future="true" data-te-format="mm/dd/yyyy" data-te-input-wrapper-init>
                <input data-rule-validDate="true" data-rule-pastDate="true" name="japan_until_when_${
                    id + 1
                }" maxlength="10" autocomplete="off" type="text" required class="spouse form-control date_picker disabled:bg-slate-200" placeholder="MM/DD/YYYY" />
           </div>
        </div>
        ...
        $("input[name='visa']").on("click", function () {
            if ($(this).val() == 1) {
                ...
                $("#visa-add-container").css("display", "flex");
            } else {
                $(".visa_group").hide();
                $(".visa").attr("disabled", true);
                $(".visa").val("");
                $("#visa-container > div").not(":first").remove();
                $("#visa-add-container").css("display", "none");
            }
        });
        ...
        $("#add-visa").on("click", () => {
            ...
            const content = `<div class="col-span-1">
                    <button class="visa-close py-2 px-3 bg-red-700 rounded w-full text-sm text-white disabled:bg-red-900">
                       x
                    </button>
                </div>
        ...
        <div class="relative col-span-4" data-te-datepicker-init data-te-inline="true" data-te-disable-future="true" data-te-format="mm/dd/yyyy" data-te-input-wrapper-init>
            ...
            const elem = $("<div>", {
                class: "hidden-visa col-span-13 md:grid grid-flow-col grid-cols-12 gap-4",
            });
            elem.append(content);
            lastChild.after(elem);
            const button = elem.find(".visa-close");
            button.on("click", (e) =>
        ...
        <div class="form-group col-span-4 mt-2 md:mt-0">
            <input name="name_relative_${
                id + 1
            }" autocomplete="off" type="text" maxlength="100" class="relatives  form-control disabled:bg-slate-200" required placeholder="Name">
        </div>
        <div class="form-group col-span-4 mt-2 md:mt-0">
            <input name="relation_relative_${
                id + 1
            }" autocomplete="off" type="text" maxlength="100" class=" form-control disabled:bg-slate-200" required placeholder="Relation">
        </div>
        <div class="form-group col-span-4 mt-2 md:mt-0">
            <input name="contact_relative_${
                id + 1
            }" autocomplete="off" onKeyPress="if(this.value.length==20) return false;" type="number" class=" form-control disabled:bg-slate-200 text-right" minlength="8" placeholder="Contact">
        </div>
        <div class="form-group col-span-4 mt-2 md:mt-0">
            <input name="address_relative_${
                id + 1
            }" autocomplete="off" type="text" maxlength="100" class=" form-control disabled:bg-slate-200" required placeholder="Address in Japan">
        </div>
    </div>`;
