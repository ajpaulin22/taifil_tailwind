    ...
    <form action="" id="personal_form" class="flex flex-col">
        ...
        <div class="md:grid grid-cols-4 gap-4">
            ...
            <div class="form-group col-span-1">
                ...
                <input maxlength="100" name="lastname" autocomplete="off" type="text" class="form-control" id="lastname" >
            </div>
            <div class="form-group col-span-1">
                <label for="firstname" class="form-label">First Name<span style="color:red">*</span>:</label>
                <input name="firstname" autocomplete="off" type="text" maxlength="100" class="form-control" id="firstname">
            </div>
            <div class="form-group col-span-1">
            ...
            <div class="form-group col-span-1">
                ...
                <input name="nickname" autocomplete="off" type="text" maxlength="100" class="form-control" id="nickanme">
            </div>
            ...
            <div class="form-group col-span-1">
                ...
                <div class="relative max-w-sm">
                    <x-picker_logo/>
                    <input datepicker name="birthday" id="birthday" autocomplete="off" value="" type="text" maxlength="100" class="date_picker" placeholder="MM/DD/YYYY">
                </div>
            </div>
            <div class="form-group col-span-1">
                <label for="address" class="form-label">Place of Birth<span style="color:red">*</span>:</label>
                <input name="birth_place" autocomplete="off" type="text" maxlength="100" class="form-control" id="birth_place">
            </div>
            <div class="form-group col-span-1">
            ...
            <div class="form-group col-span-1">
                ...
                <input name="contact" autocomplete="off" type="number" onKeyPress="if(this.value.length==20) return false;" class="form-control" id="contact">
            </div>
            <div class="form-group col-span-1">
            ...
            <div class="form-group col-span-1">
                ...
                <input name="hobbies" autocomplete="off" type="text" maxlength="100" class="form-control">
            </div>
            <div class="form-group col-span-2">
                <label for="height" class="form-label">Person to notify in case o emergency<span style="color:red">*</span>:</label>
                <input name="person_to_notify" autocomplete="off" type="text" maxlength="100" class="form-control">
            </div>
            <div class="form-group col-span-1">
            ...
            <div class="form-group col-span-2">
                ...
                <input name="person_address" autocomplete="off" type="text" maxlength="100" class="form-control">
            </div>
            <div class="form-group col-span-1">
                <label for="height" class="form-label">Contact No.<span style="color:red">*</span>:</label>
                <input name="person_contact" onKeyPress="if(this.value.length==20) return false;" autocomplete="off" type="number" class="form-control">
            </div>
            <div class="form-group col-span-1">
                <label for="height" class="form-label">Passport No.<span style="color:red">*</span>:</label>
                <input name="passport" autocomplete="off" type="text" maxlength="100" class="form-control uppercase">
            </div>
            <div class="form-group col-span-1">
                    <label for="height" class="form-label">Issue Date.<span style="color:red">*</span>:</label>
                    <div class="relative max-w-sm">
                        <x-picker_logo/>
                        <input datepicker name="issue_date" autocomplete="off" type="text" maxlength="100" class="date_picker" placeholder="MM/DD/YYYY">
                    </div>
            </div>
            <div class="form-group col-span-1">
                ...
                <div class="relative max-w-sm">
                    <x-picker_logo/>
                    <input datepicker name="expiry_date" autocomplete="off" type="text" maxlength="100" class="date_picker" placeholder="MM/DD/YYYY">
                </div>
            </div>
            <div class="form-group col-span-1">
                <label for="height" class="form-label">Issue Place<span style="color:red">*</span>:</label>
                <input name="issue_place" autocomplete="off" type="text" maxlength="100" class="form-control">
            </div>
            <div class="form-group col-span-1">
            ...
            <div class="form-group col-span-1" id="allergy" hidden>
                ...
                <input name="food_allergy" autocomplete="off" type="text" maxlength="100" class="form-control" disabled>
            </div>
            <div class="form-group col-span-1">
