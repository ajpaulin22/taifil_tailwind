...
<section class="mt-5 mb-5 ">
    <div class="min-h-screen max-w-7xl md:mx-auto mx-5 p-2  md:flex gap-5">
        ...
        <div class="w-full">
            @admin
            <div class="mt-5">
                <a href="/jp/client/gallery/create-post" class="py-2 px-4 border border-green-500 rounded shadow-lg hover:bg-green-500 hover:border-green-900 hover:text-white ">Create Post</a>
            </div>
            @endadmin
            @if(count($posts) == 0)
