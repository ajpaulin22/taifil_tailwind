...
<section class="mt-5 mb-5 ">
    ...
    <div class=" max-w-7xl md:mx-auto mx-5 p-2 md:grid grid-cols-4 gap-5">
        ...
        <div data-aos="fade-right" class="col-span-2 p-5 border-2 border-green-500 rounded shadow-lg my-5">
        ...
        <div data-aos="fade-left" class="col-span-2 p-5 border-2 border-green-500 rounded shadow-lg my-5">
