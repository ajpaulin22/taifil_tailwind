<div class="w-full max-w-sm p-4 bg-white border border-sky-200 rounded-lg shadow sm:p-8 col-span-1 my-5 md:my-0">
    ...
    <a href="/client/Biodata?data={{$type}}&type=new&cat={{$cat}}&op={{$op}}" class="text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Apply now</a>
</div>