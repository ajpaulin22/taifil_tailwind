        ...
        <div class="md:grid grid-cols-7 gap-4">
            ...
            <div class="mt-2 md:mt-0 form-group col-span-1">
                ...
                <div class="mt-2 md:mt-0 form-group col-span-1">
                    <div class="relative max-w-sm">
                        <x-picker_logo/>
                        <input datepicker name="date_from_vocational_0" autocomplete="off" value="" type="text" maxlength="100" class="date_picker" placeholder="Date From" required>
                    </div>
                </div>
                <div class="mt-2 md:mt-0 form-group col-span-1">
                    <div class="relative max-w-sm">
                        <x-picker_logo/>
                        <input datepicker name="date_until_vocational_0" autocomplete="off" value="" type="text" maxlength="100" class="date_picker" placeholder="Date Until" required>
                    </div>
                </div>
                ...
                <div class="mt-2 md:mt-0 form-group col-span-1">
                    <div class="relative max-w-sm">
                        <x-picker_logo/>
                        <input datepicker name="date_until_cert_vocational_0" autocomplete="off" value="" type="text" maxlength="100" class="date_picker" placeholder="Date Until" required>
                    </div>
                </div>
            ...
            <div class="mt-2 md:mt-0 form-group col-span-3">
                <input name="name_jpl" autocomplete="off" type="text" maxlength="100" class="form-control" placeholder="Name of School" required>
            </div>
            <div class="mt-2 md:mt-0 form-group col-span-2">
            ...
            <div class="mt-2 md:mt-0 form-group col-span-1">
                <div class="relative max-w-sm">
                    <x-picker_logo/>
                    <input datepicker name="date_until_jpl" autocomplete="off" value="" type="text" maxlength="100" class="date_picker" placeholder="Date Until" required>
                </div>
            </div>
            <div class="mt-2 md:mt-0 form-group col-span-5">
                <input name="certificate_jpl" autocomplete="off" type="text" maxlength="100" class="form-control" placeholder="Certificate Holder" required>
            </div>
            <div class="mt-2 md:mt-0 form-group col-span-2">
                <div class="relative max-w-sm">
                    <x-picker_logo/>
                    <input datepicker name="date_until_cert_jpl" autocomplete="off" value="" type="text" maxlength="100" class="date_picker" placeholder="Date Until" required>
                </div>
            </div>
            ...
            <div class="mt-2 md:mt-0 form-group col-span-1">
                <div class="relative max-w-sm">
                    <x-picker_logo/>
                    <input datepicker name="date_until_college" autocomplete="off" value="" type="text" maxlength="100" class="date_picker" placeholder="Date Until" required>
                </div>
            </div>
            <div class="mt-2 md:mt-0 form-group col-span-4">
            ...
            <div class="mt-2 md:mt-0 form-group col-span-1">
                <div class="relative max-w-sm">
                    <x-picker_logo/>
                    <input datepicker name="date_until_cert_college" autocomplete="off" value="" type="text" maxlength="100" class="date_picker" placeholder="Date Until" required>
                </div>
            </div>
        </div>
        <div class="self-end">
