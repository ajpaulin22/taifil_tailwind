<section class="mt-10">
    <div data-aos="flip-down" class="min-h-screen max-w-7xl md:mx-auto mx-5">
        <div>
            <h1 class="text-center text-4xl md:text-5xl mt-9 font-bold bg-green-500 p-5 rounded-t-lg text-white">出発 2023</h1>  
        </div>
        ...
        <div data-aos="flip-up" class="total my-5">
            <div class="">
                <h1 class="text-center text-4xl md:text-5xl mt-9 font-bold bg-green-500 p-5 rounded-t-lg text-white">総出発数</h1>  
            </div>
